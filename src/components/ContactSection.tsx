            ...
            <div className="mt-8 pt-8 border-t border-border">
              ...
              <div className="flex gap-4">
                <Button variant="outline" size="icon" asChild>
                  <a href="https://linkedin.com/in/shreyansh-singh" target="_blank" rel="noopener noreferrer">
                    <Linkedin className="h-4 w-4" />
                  </a>
                </Button>
                
                <Button variant="outline" size="icon" asChild>
                  <a href="https://github.com/shreyanshsingh" target="_blank" rel="noopener noreferrer">
